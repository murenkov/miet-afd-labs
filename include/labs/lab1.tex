...
Используемое оборудование или ПО: материал подготовлен на основании версии Keysight Advanced Design System 2020 upd1.

\section{Техническое задание}

Рассчитать и спроектировать согласующую цепь с короткозамкнутым шлейфом на заданные входные $Z_S = 50\text{~Ом}$ и выходные $Z_L = 35 + j 7 \text{~Ом}$ сопротивления на заданную частоту $F_c = 7 \text{~ГГц}$ и ВЧ-подложку.
...
\begin{comment}
\begin{table}[!ht]
    \caption{Параметры цепи}
    \label{tab:specification-1}
\end{table}
\end{comment}
